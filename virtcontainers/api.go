...
func DeleteContainer(ctx context.Context, sandboxID SandboxID, containerID string) (VCContainer, error) {
...
func StartContainer(ctx context.Context, sandboxID SandboxID, containerID string) (VCContainer, error) {
...
func StopContainer(ctx context.Context, sandboxID SandboxID, containerID string) (VCContainer, error) {
...
func EnterContainer(ctx context.Context, sandboxID SandboxID, containerID string, cmd types.Cmd) (VCSandbox, VCContainer, *Process, error) {
...
func StatusContainer(ctx context.Context, sandboxID SandboxID, containerID string) (ContainerStatus, error) {
...
func KillContainer(ctx context.Context, sandboxID SandboxID, containerID string, signal syscall.Signal, all bool) error {
...
func ProcessListContainer(ctx context.Context, sandboxID SandboxID, containerID string, options ProcessListOptions) (ProcessList, error) {
...
func UpdateContainer(ctx context.Context, sandboxID SandboxID, containerID string, resources specs.LinuxResources) error {
...
func StatsContainer(ctx context.Context, sandboxID SandboxID, containerID string) (ContainerStats, error) {
...
func togglePauseContainer(ctx context.Context, sandboxID SandboxID, containerID string, pause bool) error {
	if sandboxID == "" {
		return errNeedSandboxID
	}
...
func PauseContainer(ctx context.Context, sandboxID SandboxID, containerID string) error {
...
func ResumeContainer(ctx context.Context, sandboxID SandboxID, containerID string) error {
