...
func (h *hyper) getVMPath(id string) string {
	return store.SandboxRuntimeRootPath(SandboxID(id))
}
...
func (h *hyper) killOneContainer(cID ContainerID, signal syscall.Signal, all bool) error {
	killCmd := hyperstart.KillCommand{
		Container:    string(cID),
		Signal:       signal,
		AllProcesses: all,
	}
...
func (h *hyper) processListOneContainer(sandboxID SandboxID, cID ContainerID, options ProcessListOptions) (ProcessList, error) {
...
func (h *hyper) updateInterface(inf *Interface) (*Interface, error) {
	// hyperstart-agent does not support update interface
	return nil, nil
}

func (h *hyper) listInterfaces() ([]*Interface, error) {
	// hyperstart-agent does not support list interfaces
	return nil, nil
}

func (h *hyper) updateRoutes(routes []*Route) ([]*Route, error) {
	// hyperstart-agent does not support update routes
	return nil, nil
}

func (h *hyper) listRoutes() ([]*Route, error) {
